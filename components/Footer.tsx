        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-zinc-500">
              Freelance Web Developer basé à Fès, Morocco — création
              d'applications web modernes, performantes et orientées résultats.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-sm">
              <a
                href="mailto:yahyatemouch10@gmail.com"
                className="block text-zinc-200 transition hover:text-violet-300"
              >
                yahyatemouch10@gmail.com
              </a>
              <a
                href="tel:+212609560141"
                className="mt-2 block text-zinc-400 transition hover:text-violet-300"
              >
                +212609560141
              </a>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 block text-zinc-500 transition hover:text-violet-300"
              >
                Fès, Morocco
              </a>
